...
public class Profile extends HttpServlet
{
	...
	// Header style
	out.println("  header { background-color: green; color: white; padding: 20px; text-align: center; font-size: 24px; font-weight: bold; }");
	// Container layout
	...
	out.println("</div>");
        ...
        out.println("<h2 style='color: Orange; margin-top: 20px; text-align: center;'>Profile Page</h2>");
