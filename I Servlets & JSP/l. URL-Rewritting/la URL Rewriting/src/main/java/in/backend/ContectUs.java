...
public class ContectUs extends HttpServlet
{
	...
	// Header style
	out.println("  header { background-color: #ff0df7; color: white; padding: 20px; text-align: center; font-size: 24px; font-weight: bold; }");
	// Container layout
	...
	out.println("<header>")
        ...
        out.println("<a href = '"+resp.encodeURL("homePage")+"'>Home</a>");
        out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
        out.println("<a href = '"+resp.encodeURL("profilePage")+"'>Profile</a>");
        out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
        out.println("<a href = '"+resp.encodeURL("contectUs")+"'>Contect Us</a>");
        out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
	...
	out.println("</div>");
        ...
        out.println("<h2 style='color: Red; margin-top: 20px; text-align: center;'>Contect Us Page Page</h2>");
